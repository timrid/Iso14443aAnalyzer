...
:	Analyzer2(),  
	mSettings( new Iso14443aAnalyzerSettings() ),
...
U32 Iso14443aAnalyzer::GenerateSimulationData( U64 minimum_sample_index, U32 device_sample_rate, SimulationChannelDescriptor** simulation_channels )
{
